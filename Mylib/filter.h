...
#define KALMAN_QD				 0.03
#define KALMAN_RD        10.0000

#define KALMAN_QFLOW		 0.03
#define KALMAN_RFLOW     15.0000
...
double KalmanFilter_d(const double ResrcData,double ProcessNiose_Q,double MeasureNoise_R);
#endif
