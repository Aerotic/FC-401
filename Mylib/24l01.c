...
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0xE1,0xE2,0xE3,0xE4,0xE5}; //发送地址
...
{  
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA|RCC_AHB1Periph_GPIOC, ENABLE);//使能A\C时钟
	
	//GPIOA4,8推挽输出    //A4:CSN  A8:CE
...
/*RADIO 接收数据*/
void RECEIVE_RADIO_DATA(void)
{
	u8 RX_FLAG = NRF24L01_RxPacket(RADIO_RX_DATA);
}
